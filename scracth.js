...
// accepts  unsorted args and determines if it has a duplicate 
...
// areThereDuplicates(1, 2, 1, 5) //true
// areThereDuplicates(3,5,6,3,9, 1) // true
areThereDuplicates("a", "b", "c" , "c" ,"z") //true 